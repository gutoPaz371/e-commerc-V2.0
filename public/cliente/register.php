<?php
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    require_once "../../config/Crud.php";
      ...
      $cli->senha=password_hash($_POST['senha'],PASSWORD_DEFAULT);
      if($cli->insert())header("location:./login.php");    
  }
?>
<!DOCTYPE html>
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="row flex-between-center mb-2">
                  ...
                  <div class="col-auto fs-10 text-600"><span class="mb-0 undefined">Tem uma conta?</span> <span><a href="./login.php">Entra</a></span></div>
                </div>
                <form action="#" method="post">
                  <div class="mb-3">
                    <input class="form-control" type="text" autocomplete="on" placeholder="Nome" name="nome" required/>
                  </div>
                  <div class="mb-3">
                    <input class="form-control" type="email" autocomplete="on" placeholder="Email" name="email" required/>
                  </div>
                  <div class="row gx-2">
                    <div class="mb-3 col-sm-6">
                      <input class="form-control" id="senha" type="password" autocomplete="on" placeholder="Senha" name="senha" oninput="verificarSenhas()" required/>
                    </div>
                    <div class="mb-3 col-sm-6">
                      <input class="form-control" id="confirmarSenha" type="password" autocomplete="on" placeholder="Confirmar Senha" oninput="verificarSenhas()" required/>
                    </div>
                  </div>
                  <div id="mensagem" class="text-danger"></div>
                  
                  <div class="mb-3">
                    <button id="bt" class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit" disabled>Registrar</button>
                  </div>
                </form>
                <script>
