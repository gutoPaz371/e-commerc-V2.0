<?php
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if($id=$cli->fazerLogin()){
      session_start();
      $_SESSION['id']=$id;
      header("location:./main-grid.php");
    }else echo "Login errado";
  }
?>
<!DOCTYPE html>
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="row flex-between-center mb-2">
                  ...
                  <div class="col-auto fs-10 text-600"><span class="mb-0 undefined">ou</span> <span><a href="./register.php">Criar conta</a></span></div>
                </div>
