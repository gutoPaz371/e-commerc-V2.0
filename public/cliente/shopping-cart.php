                  ...
                  ?>
                    <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                      <div class="col-8 py-3 px-x1">
                        <div class="d-flex align-items-center"><a href="#"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../vendedor/uploads/produtos/fts/<?php echo $row['idP'];?>/0.png" alt="" width="60" /></a>
                          <div class="flex-1">
                            <h5 class="fs-9"><a class="text-900" href="#"></a><?php echo $row['Pnome'] ?></h5>
                            <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remover</a></div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row fw-bold gx-x1 mx-0">
                ...
                <div class="col px-0">
                  <div class="row gx-x1 mx-0">
                    <div class="col-md-8 py-2 px-x1 d-none d-md-block text-center"><?php echo $qnt; ?> (items)</div>
                    <div class="col-12 col-md-4 text-end py-2 px-x1"><?php echo "R$ ".$valor; ?></div>
                  </div>
                </div>
              </div>
            </div>
