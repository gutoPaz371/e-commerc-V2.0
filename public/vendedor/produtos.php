...
require_once "../../config/Crud.php";
  function status($st){
    switch($st){
      case 0: 
        echo "<span class='badge rounded-pill badge-subtle-danger'>Desativado</span>";
        break;
      case 1:
        echo "<span class='badge rounded-pill badge-subtle-success'>Ativo</span>";
        break;
    }
  }
?>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Produtos</h5>
                </div>
            ...
            <div class="card-body pt-0">
              <div class="tab-content">
                      ...
                      <table class="table table-bordered table-striped fs-10 mb-0">
                        <thead class="bg-200">
                          <tr>
                            ...
                            <th class="text-900 sort" data-sort="name">Produto</th>
                            <th class="text-900 sort" data-sort="age">Valor</th>
                            <th class="text-900 sort" data-sort="email">Status</th>
                            <th class="text-900 sort" data-sort="age" style="text-align: right;">Ação</th>
                          </tr>
                        </thead>
                        <tbody class="list">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-0f88421a-88e5-41e8-a4dd-2954e44632d8" id="dom-0f88421a-88e5-41e8-a4dd-2954e44632d8">
