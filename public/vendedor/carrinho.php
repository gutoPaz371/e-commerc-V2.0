              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="tables">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../modules/tables/advance-tables.html">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Carrinhos</h5>
                </div>
            ...
            <div class="card-body pt-0 px-0">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-028f0416-8fc0-404e-95fb-2391ae7f4a20" id="dom-028f0416-8fc0-404e-95fb-2391ae7f4a20">
                  <div id="tableExample4" data-list='{"valueNames":["name","email","payment"],"filter":{"key":"payment"}}'>
                    <div class="row justify-content-end g-0">
                      <div class="col-auto px-3">
                        <select hidden class="form-select form-select-sm mb-3" aria-label="Bulk actions" data-list-filter="data-list-filter">
                    ...
                    <div class="table-responsive scrollbar">
                      <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                        <thead class="bg-200">
                          <tr>
                            <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="name">Cliente</th>
                            <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="email">Valor</th>
                            <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="email">UNI.</th>
                            <th class="text-900 sort align-middle white-space-nowrap text-end pe-4" data-sort="payment" hidden>Pagamento</th>
                          </tr>
                        </thead>
                                ...
                                for($i=0;$i<$cont;$i++){
                                    ?>
                                        <tr class="btn-reveal-trigger">
                                            <th class="align-middle white-space-nowrap name"><a href="#"><?php echo $dados[$i]['nome']; ?></a></th>
                                            <td class="align-middle white-space-nowrap email">R$ <?php echo $dados[$i]['valor']; ?></td>
                                            <td class="align-middle white-space-nowrap email"><?php echo $dados[$i]['qnt'] ?></td>
                                            <td hidden class="align-middle text-end fs-9 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
                                            </td>
                                        </tr>
                                    <?php
                                }
