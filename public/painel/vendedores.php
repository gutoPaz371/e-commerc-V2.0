<?php
  ...
  function status($st){
    switch ($st){
      case 0:
        return "<span class='badge bg-danger' id='st_row'>Desativado</span>";
        break;
      case 1:
        return "<span class='badge bg-success' id='st_row'>Ativo</span>";
        break;        
    }
  }
  //UPDATE VENDEDOR
...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <body>
                      ...
                      <table class="table table-bordered table-striped fs-10 mb-0">
                        ...
                        <tbody class="list">
                          <?php while($row = $res->fetch_array()){ ?>
                            <tr>
                              <td class="name" id="id_row"><?php echo $row['id']; ?></td>
                              <td class="name" id="nome_row"><?php echo $row['nome']; ?></td>
                              <td class="email" id="email_row"><?php echo $row['email'] ?></td>
                              <td class="" ><?php echo status($row['status']); ?></td>
                              <td class="age" style="text-align: right;width: 50px;"><button onclick="sendDadosVendedor_for_modalEditVendedor(this)" class="btn btn-info me-1 mb-1" type="button" data-bs-target="#edit_vendedor" data-bs-toggle="modal"><span class="fas fa-user-edit"></span></button></td>
                            </tr>
                          <?php } ?>
                                  ...
                                  <div class="modal-body p-0">
                                    ...
                                    <div class="p-4 pb-0">
                                      <form action="#" method="post">
                                        ...
                                        <div class="mb-3">
                                          <label class="col-form-label" for="recipient-name">Nome:</label>
                                        ...
                                        <div class="mb-3">
                                          <label class="col-form-label" for="">Conta:</label>
                                            <select name="st" id="recipient-st" class="form-select" aria-label="Default select example">
                                              <option id="st00" value="0">Desativado</option>
                                              <option id="st01" value="1">Ativo</option>
                                            </select>
                                        </div>
    ...
    <script>
      function sendDadosVendedor_for_modalEditVendedor(){
        const id = document.getElementById('id_row');
        const n = document.getElementById('nome_row');
        const e = document.getElementById('email_row');
        const s = document.getElementById('st_row');
        ...
        inp_st.value=(function(st){
          if(st=="Ativo")return 1;return 0;
        })(s.innerHTML);
      }
